...
export const FilesystemMode = Schema.Literals(["read-only", "workspace-write", "danger-full-access"]);
...
export const ApprovalPolicy = Schema.Literals(["never", "on-failure", "on-request", "unless-trusted"]);
